public class Story {
    ...
    Story() {
        ...
        start_story = new Situation(
                "---===Первый день в Мафии===---",
                "Ну чтож, " + Main.manager.name + ".. Я искал тебя чтобы предложить работу, но ты конечно можете сделать и неугодное мне решение *на вас навели пистолет*\n"
                        + "(1) 'Хорошо.. Я буду работать не тебя...'\n"
                        + "(2) 'Низачто! Лудше я умру!'",
                2, 0, 0, 0, 0);
        start_story.direction[0] = new Situation(
                "---===Принят в Мафию===---",
                "'Отлично! Мои люди очень заняты, но чтобы ты не сбежал я дам тебе авансом 100.000$, и будь уверен, ты сможешь заработать в разы больше, если останешься работать у меня!'\n"
                        + "(1) Взять деньги",
                1, 0, 0, 10, 0);
        ...
        start_story.direction[0].direction[0] = new Situation(
                "---===Аванс получен===---",
                "'Cледуй за моим человеком, он покажет тебе путь до воей комнаты'\n"
